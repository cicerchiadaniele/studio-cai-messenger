...
export default function CondoMessenger() {
  ...
  const [webhook] = useState(load("cm_webhook", "https://hook.eu1.make.com/xvuih8pqxk96q9v6bjpls6u8e4k4f5qv"));
    ...
    <div className="min-h-screen w-full bg-neutral-50 text-neutral-900" style={cssVars}>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="text-right">v7.2 – Ultimo aggiornamento: 01/10/2025</div>
        </div>
      </footer>
    </div>
  );
