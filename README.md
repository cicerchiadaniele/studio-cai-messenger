# Studio CAI – Portale condomini (Segnalazioni) v2.1
...
Versione 2.1 del 23/09/2026 (campi a 16px e date allineate su iPhone e iPad): vedi `CHANGELOG_v2.1.md`. Versione 2.0 del 22/09/2026 (numerazione ripartita dopo la 9.6): vedi `CHANGELOG_v2.0.md`.
